...
public class MoviesRepository {
	...
	private void addMovies() {
		...
		plan9.setSynopsis("Aliens resurrect dead humans as zombies and vampires to stop humanity from creating the Solaranite (a sort of sun-driven bomb).");
		movies.add(plan9);
		...
		guardians.setSynopsis("A group of intergalactic criminals are forced to work together to stop a fanatical warrior from taking control of the universe.");
		...
		rings.setSynopsis("Gandalf and Aragorn lead the World of Men against Sauron's army to draw his gaze from Frodo and Sam as they approach Mount Doom with the One Ring.");
		movies.add(rings);
	}
}
